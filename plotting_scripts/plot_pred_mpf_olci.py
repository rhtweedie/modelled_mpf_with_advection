...
def main():
    ...
    years_olci = listdir(f'/home/htweedie/melt_ponds/data/OLCI/olci')
    years_olci.remove('LongitudeLatitudeGrid-n12500-Arctic.h5')
    years_olci.remove('readme.txt')
    ...
    years = list(set(years_olci) & set(years_misr))
    ...
    for year in years:
        ...
        for month in months:
            ...
            month_mean = np.load(f'/home/htweedie/melt_ponds/data/OLCI/olci/{year}/mean_{month}_{year}.npy')
        ...
        '''
        # interpolate MPF data to MISR grid coordinates
        try:   
            print("Interpolating...")
        ...
        mpf_interpolated = np.load(f'/home/htweedie/melt_ponds/data/interpolated_mpf/interpolated_mpf_{year}.npy')
        print(f'Interpolated MPF data read from /home/htweedie/melt_ponds/data/interpolated_mpf/interpolated_mpf_{year}.npy')
    ...
    print(f'r2 per year: {annual_r2}')
    mean_r2 = np.mean(annual_r2)
    print(f'Mean annual r2: {mean_r2}')
    std_r2 = np.std(annual_r2)
    print(f'Standard deviation of mean annual r2: {std_r2}')
